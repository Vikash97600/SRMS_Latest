...
def get_course_choices():
    """Dynamically get course choices from database"""
    try:
...
def get_session_year_choices():
    """Dynamically get session year choices from database"""
    try:
...
class AddStudentForm(forms.Form):
    ...
    course_id = forms.ChoiceField(label="Course", choices=get_course_choices, widget=forms.Select(attrs={"class":"form-control", "placeholder": "Select course"}))
    gender = forms.ChoiceField(label="Gender", choices=gender_list, widget=forms.Select(attrs={"class":"form-control", "placeholder": "Select gender"}))
    session_year_id = forms.ChoiceField(label="Session Year", choices=get_session_year_choices, widget=forms.Select(attrs={"class":"form-control", "placeholder": "Select session"}))
